...
public interface ProblemMapper {
    Page<ProblemPage> getProblemList(@Param("tags") List<String> tags, @Param("tagSize") int tagSize, @Param("title") String title, @Param("order") String order, @Param("sort") String sort);
